...
public class TvShowAdapter extends RecyclerView.Adapter<TvShowAdapter.TvShowViewHolder> {
    ...
    public TvShowAdapter(Context context, List<TVShow> tvShowList,AlphabetCategoryAdapter.OnTVShowClickListener listener) {
    ...
    private void updateMovie(TVShow tvShow, String thumbUrl, String largeUrl,
        ...
        DocumentReference movieRef = db.collection("TVShow_memo")
